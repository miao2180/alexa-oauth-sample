...
public class RegisterController {
    ...
    private void validateUsername(String userName) throws Exception{
        try {
            ...
            ListUsersResult userResult = cognitoClient.getUsersByFilter("username", userName, PATIENT_POOL_ID);
    ...
    private void validateEmail(String emailAddr) throws Exception {
        try {
            ...
            ListUsersResult userResult = cognitoClient.getUsersByFilter(EMAIL, emailAddr, PATIENT_POOL_ID);
            if(userResult != null && userResult.getUsers().size() > 0) {
